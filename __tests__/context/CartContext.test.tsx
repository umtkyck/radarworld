...
const mockProduct: Product = {
  id: 'test-product-1',
  slug: 'test-radar-sensor',
  name: 'Test Radar Sensor',
  shortDescription: 'A test radar sensor',
...
const mockProduct2: Product = {
  id: 'test-product-2',
  slug: 'test-radar-sensor-2',
  name: 'Test Radar Sensor 2',
  shortDescription: 'Another test radar sensor',
  ...
  problemTags: ['ball-tracking'],
  applications: ['Golf launch monitors'],
  specifications: {
    frequency: '24 GHz',
    range: '200m',
    accuracy: '±2mm',
